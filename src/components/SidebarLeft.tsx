                ...
                >
                    ...
                    <div className="p-3 border-t border-gray-100 bg-gray-50/30">
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <button
                                ...
                                className={`flex items-center justify-between px-3 py-2 rounded-lg text-xs font-bold border bg-gray-800 border-gray-700 text-emerald-400 hover:bg-gray-700 mb-1 transition-all`}
                            >
                                <div className="flex items-center gap-2">
                                    <Key size={14} />
                                    <span>Local API Vault</span>
                                </div>
                                <span className="text-[9px] text-gray-400 uppercase">Config</span>
                            </button>
                    ...
                    <div className="p-3 border-t border-gray-100 bg-gray-50 flex justify-between items-center">
                        ...
                        <div className="flex gap-2">
                            <button onClick={handleExportData} className="p-1.5 hover:bg-gray-200 rounded text-gray-600 flex items-center gap-1 text-[10px] font-bold transition-all" title="导出 JSON">
                                <Download size={12} /> Backup
                            </button>
                            <button onClick={() => importInputRef.current?.click()} className="p-1.5 hover:bg-gray-200 rounded text-gray-600 flex items-center gap-1 text-[10px] font-bold transition-all" title="导入 JSON">
