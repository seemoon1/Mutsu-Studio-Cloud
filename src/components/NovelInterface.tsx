                        ...
                        `}>
                            ...
                            <div className="flex-1 overflow-y-auto p-6 space-y-8 scrollbar-thin">
                                ...
                                <div className="mt-6 pt-4 border-t border-white/5">
                                    <div className={`text-[9px] ${theme.text} opacity-40 leading-tight font-mono text-justify`}>
                                        <span className="font-bold text-red-500/80">WARNING:</span> This project acts as a technical frontend only.
                                        Content is generated by third-party APIs (DeepSeek/Volcengine).
                                        Users are solely responsible for their inputs and outputs.
                                    </div>
                                </div>
